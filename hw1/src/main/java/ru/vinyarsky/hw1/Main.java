...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CSVParser reader = new CSVParser(new FileReader(pathToFile), CSVFormat.DEFAULT);
        List<String> emails = reader.getRecords().stream().map(line -> line.get(0).trim()).collect(Collectors.toList());
